...
public class MobileTerminalDeviceConfig {

	private String terminalSystemType;
	private List<String> terminalFieldList;
	private List<String> channelFieldList;
	private List<CapabilityDto> capabilityList;
	
	public MobileTerminalDeviceConfig() {
	}
	...
	public List<CapabilityDto> getCapabilityList() {
